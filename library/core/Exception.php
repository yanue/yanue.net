...
class Exception extends \Exception
{
    ...
    public function exception_handler($e)
    {
        ...
        echo '<p fdfs="trance">[Line ' . $error['line'] . '] ' . $error['file'] . ' <br /> ERR MSG: ' . $error['message'] . '</p>';
    }
    ...
    private static function outMsg($errno, $errMsg, $errfile, $errline)
    {
        ...
        echo '<p fdfs="trance">[Line ' . $errline . '] ' . $errfile . ' <code>' . $errTypeName . '[' . $errno . ']</code> : ' . $errMsg . '</p>';
        $msg = '[Line ' . $errline . '] ' . $errfile . ' ' . $errTypeName . '[' . $errno . '] : ' . $errMsg ;
        Debug::log($msg);
    }
