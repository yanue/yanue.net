...
class Dispatcher
{
    ...
    {
        $this->_appPath = WEB_ROOT . '/app/' . APP_NAME;
    ...
    private function parseMvc()
    {
        ...
        if (isset($requestPath[0]) && file_exists($this->_appPath . '/controller/' . $requestPath[0])) {
            # 模块文件夹存在
    ...
    {
        $moduleUri = $this->_moduleName ? '/' . $this->_moduleName : '';
    ...
    public function addUri($curUrl, $uri, $setSuffix = true)
    {
        // parse uri
