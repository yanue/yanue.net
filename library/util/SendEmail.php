...
class SendEmail {
	...
	{
	    $config = Config::getSite('mail');
		$this->charset = isset($config['charset']) && !empty($config['charset']) ? $config['charset'] : 'utf-8';
		...
		$this->_safe_mode = ( !version_compare(PHP_VERSION, 5.4) && (bool) @ini_get('safe_mode'));
