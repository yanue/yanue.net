...
<title><?php if (!empty($q)) echo "搜索：" . strip_tags($q) . " - "; ?>Yanue 搜索 - Powered by xunsearch</title>
<meta http-equiv="keywords" content="Fulltext Search Engine Yanue xunsearch" />
<meta http-equiv="description" content="Fulltext Search for Yanue, Powered by xunsearch/1.4.8 " />
      ...
      <form class="form-search" id="q-form" method="get">
        ...
        <div class="condition" id="q-options">
          ...
          <select name="s" size="1">
			...
			<option value="created_DESC" <?php echo $s_created_DESC; ?>>Created从大到小</option>
					<option value="created_ASC" <?php echo $s_created_ASC; ?>>Created从小到大</option>
          </select>
          排序
		</div>
      </form>
      ...
      <dl class="result-list">
        ...
        <dd>
          ...
          <p class="field-info text-error">
            <span><strong>Created:</strong><?php echo htmlspecialchars($doc->created); ?></span>
				<span><strong>Cid:</strong><?php echo htmlspecialchars($doc->cid); ?></span>
          </p>
        </dd>
        <?php endforeach; ?>
      </dl>
...
<footer>
  <div class="container">
    <p>(C)opyright 2011 - Yanue search - 页面处理总时间：<?php printf('%.4f', $total_cost); ?>秒<br>
