...
!defined('ERROR_TITLE_IS_NOT_EXISTS')    AND define('ERROR_TITLE_IS_NOT_EXISTS',          1030);
!defined('ERROR_TITLE_IS_EXISTS')       AND define('ERROR_TITLE_IS_EXISTS',          1031);
...
$msg = array(
    ...
    ERROR_INVALID_REQUEST_PARAM     => '缺少请求参数或请求参数不正确',
    ERROR_ILLEGAL_API_SIGNATURE     => '非法的API签名',
    ERROR_NOTHING_HAS_CHANGED       => '修改或插入不成功',
    ...
    ERROR_TITLE_IS_NOT_EXISTS       => '标题不存在',
    ERROR_TITLE_IS_EXISTS           => '标题已经存在',
